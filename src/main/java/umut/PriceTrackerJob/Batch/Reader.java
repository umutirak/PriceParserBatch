...
import umut.PriceTrackerJob.Repositories.ProductCategoriesRepository;
import umut.PriceTrackerJob.Repositories.ProductPricesRepository;
import umut.PriceTrackerJob.Repositories.ProductsRepository;
...
@Component
public class Reader implements ItemReader<CustomProductModel> {
    ...
    private final AtomicInteger productIndex;
    private List<CustomProductModel> customProductModelList;

    public Reader(ProductsRepository productsRepository, ProductCategoriesRepository categoriesRepository, ProductPricesRepository pricesRepository) {
    ...
    public void initialize(String categoryUrl) {
        ...
        while (true) {
            ...
            if (!document.baseUri().equals(finalUrl)) {
                break;
            }
